...
- [Video Ram Buffers](/component/gpu#video_ram_buffers) This list of component api is getting long, so the new video ram api is
...
![](https://ocdoc.cil.li/_media/api:oc-256-color.png)
